...
export default function Page() {
  return (
    <Equipment
      ...
      image={'/excavator/midi-kastor-hyd-cover.jpeg'}
      content={
        <>
          <P>
      ...
      brochure="https://www.seppi.com/en-ca/mulcher-mower-shredder-tiller-stump-grinder/excavator-mulchers/1055-midi-kastor-hyd.html?depliant=491"
    />
  )
}
