...
export default function Page() {
  return (
    <Equipment
      title={'Star FC Hyd'}
      image={'/excavator/star-fc-hyd-cover.jpeg'}
      content={
        <>
          <P>
            ...
            stones, even at depth.
          </P>
          <P>
            With the aggressive patented rotor of new generation V-LOCK with efficient hammer combination of the new
            type, ULTRA MONO PROTECT + MONO & ULTRA MONO EXTREME with additional tungsten carbide tips STAR-FC hyd
            mulches wood up to 40 cm in diameter and crushes stones up to 15 cm, and tills as deep as 30 cm below the
            surface. Very strong frame, for a very long life made of wearresistant steel with tempered counter knives
            for a perfect mulching result. CARBONCHAIN gear belts provide high strength and length stability with high
            flexibility. STAR-FC hyd has a very strong chassis S420 with replacable plates AR400 for a very long life.
            ISOBUS system (temperature, cooling, hour counter) - with ISOBUS terminal The multi-functionality is one of
            most important features of SEPPI M. machines. Available working width: 75, 100, 125 [30", 39", 49"].
          </P>
        </>
      }
      ...
      brochure="https://www.seppi.com/en-ca/mulcher-mower-shredder-tiller-stump-grinder/excavator-mulchers/1064-star-fc-hyd.html?depliant=507"
    />
  )
}
